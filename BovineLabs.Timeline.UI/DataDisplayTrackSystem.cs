...
namespace BovineLabs.Timeline.UI
{
    ...
    public partial struct DataDisplayTrackSystem : ISystem, ISystemStartStop
    {
        ...
        {
            ui = new UIHelper<DataDisplayViewModel, DataDisplayViewModel.Data>(ref state, ComponentType.ReadOnly<ClipDataId>());
            scratch = new NativeList<DataDisplayViewModel.Data.Row>(Allocator.Persistent);
        }

        public void OnDestroy(ref SystemState state) => scratch.Dispose();
        public void OnStartRunning(ref SystemState state) => ui.Bind();
        public void OnStopRunning(ref SystemState state) => ui.Unbind();
